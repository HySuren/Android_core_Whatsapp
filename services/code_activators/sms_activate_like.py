...
class SmsActivateLike(BaseActivator):

    NAME = ActivatorName.SMS_ACTIVATE_LIKE
        ...
        while True:
            try:
                response = requests.get(
                    url="http://194.113.104.15:9191/stubs/handler_api.php?",
                    params={
                        "api_key": 'eqogoknwcermicmytzbktfusemjbotqk',
                        "action": "getNumber",
                        "service": srvice,
    ...
    def get_code(self, id: int, timeout=60):
        ...
        while True:
            response = requests.get(
                "http://194.113.104.15:9191/stubs/handler_api.php?",
                params={
                    "api_key": 'eqogoknwcermicmytzbktfusemjbotqk',
                    "action": "getStatus",
                    "id": id
